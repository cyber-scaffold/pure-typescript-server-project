...
export { saveProjectEntryFileAbsolutePath } from "@/frameworks/mvc-server-tool-box/globalSingletonStorage";
export { readProjectEntryFileAbsolutePath } from "@/frameworks/mvc-server-tool-box/globalSingletonStorage";
